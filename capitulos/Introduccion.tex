...
Dentro del capítulo de Implementación de CORDIC se expondrá las herramientas usadas y se mostrará tres implementaciones de CORDIC: básica, \textit{pipelining} y una con \text{pipelining} y punto flotante.
