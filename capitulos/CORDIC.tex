...
\subsection{Redundant-Number-Based CORDIC}
...
\todo{Separacion en subsection de cada articulo?}
...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|l|}
			...
			Multiplicador CORDIC                          & 5.259  & 679                                                   & 96    \\ \hline
